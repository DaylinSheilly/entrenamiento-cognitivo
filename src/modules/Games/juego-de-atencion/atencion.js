    ...
    <div className="attention-juego-contenedor">
      ...
      {juegoTerminado ? (
        <div className="attention-fin-juego">
          <attention-h1>¡Felicidades! Has terminado el juego.</attention-h1>
          <attention-p>Tu puntaje final fue: {puntaje}</attention-p>
          <attention-button onClick={reiniciarJuego}>Reiniciar juego</attention-button>
        </div>
      ) : (
        <div>
          <canvas 
